...
for i in order_list:
    ...
    space1 = " " * (26 - len(item_name))
    space2 = " " * (6 - len(str(price)))
...
#prices = [i["Price"] * i["Quantity"] for i in order_list]
#print(f'Item Totals: {prices}')
print(f'Grand Total: {sum([i["Price"] * i["Quantity"] for i in order_list]):.2f}')